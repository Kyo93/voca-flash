...
export const CHARACTER_CATALOG: CharacterDefinition[] = [
  ...
  {
    id: 'falling_leaf_tree',
    costXp: 0,
    rarity: 'rare',
    nameKey: 'characters.items.falling_leaf_tree.name',
    descriptionKey: 'characters.items.falling_leaf_tree.description',
    poseLabelKey: 'characters.items.falling_leaf_tree.pose',
    icon: 'park',
    swatchClass: 'from-secondary-container to-primary',
    evolutionStages: [
      stage('falling_leaf_tree', 1, 0, 'park', 'from-secondary-container to-primary'),
      stage('falling_leaf_tree', 2, 0, 'eco', 'from-secondary to-primary'),
      stage('falling_leaf_tree', 3, 0, 'forest', 'from-primary-container to-secondary'),
      stage('falling_leaf_tree', 4, 0, 'auto_awesome', 'from-secondary to-warm-accent'),
    ],
  },
  {
    id: 'playful_dog',
    costXp: 0,
    rarity: 'rare',
    nameKey: 'characters.items.playful_dog.name',
    descriptionKey: 'characters.items.playful_dog.description',
    poseLabelKey: 'characters.items.playful_dog.pose',
    icon: 'pets',
    swatchClass: 'from-secondary-container to-warm-accent',
    evolutionStages: [
      stage('playful_dog', 1, 0, 'pets', 'from-secondary-container to-warm-accent'),
      stage('playful_dog', 2, 0, 'celebration', 'from-warm-accent-container to-secondary'),
      stage('playful_dog', 3, 0, 'psychology_alt', 'from-secondary to-primary'),
      stage('playful_dog', 4, 0, 'auto_awesome', 'from-warm-accent to-secondary'),
    ],
  },
  {
    id: 'rampaging_t_rex',
    costXp: 0,
    rarity: 'epic',
    nameKey: 'characters.items.rampaging_t_rex.name',
    descriptionKey: 'characters.items.rampaging_t_rex.description',
    poseLabelKey: 'characters.items.rampaging_t_rex.pose',
    icon: 'pets',
    swatchClass: 'from-warm-accent to-primary',
    evolutionStages: [
      stage('rampaging_t_rex', 1, 0, 'pets', 'from-warm-accent-container to-warm-accent'),
      stage('rampaging_t_rex', 2, 0, 'local_fire_department', 'from-warm-accent to-primary'),
      stage('rampaging_t_rex', 3, 0, 'psychology_alt', 'from-primary to-warm-accent'),
      stage('rampaging_t_rex', 4, 0, 'auto_awesome', 'from-warm-accent to-secondary'),
    ],
  },
  {
    id: 'arcane_brawler',
