  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-on-surface-variant mt-1">Tổng quan hệ thống VocaFlash</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-stone-100 flex items-center gap-3">
          ...
          <h2 className="font-black text-secondary">Từ vựng mới thêm gần đây</h2>
        </div>
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-3 py-12">
            ...
            <p className="text-stone-400">Chưa có từ vựng nào. Thêm từ đầu tiên!</p>
