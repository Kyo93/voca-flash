...
export default function DashboardHero({
  ...
  return (
    <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-primary-container to-primary px-10 py-8 mb-8 flex items-center shadow-2xl group border border-white/10">
