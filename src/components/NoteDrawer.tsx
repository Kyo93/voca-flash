            ...
            <div className="space-y-8">
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full h-48 bg-surface-container-low border-none rounded-3xl p-8 text-on-surface shadow-inner text-xl leading-relaxed italic input-tactile-focus transition-all resize-none font-normal"
                  autoFocus
                />
              </div>
