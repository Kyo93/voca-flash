...
export default function MobileAchievementsView({
  ...
  return (
    <main data-mobile-achievements className="mobile-page min-h-full">
      <Link
        to="/progress"
      ...
      <section className="mobile-panel p-4">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <div className="rounded-2xl bg-primary-container p-3 text-on-primary-container">
            <p className="text-[11px] font-medium uppercase tracking-wider opacity-75">{t('achievements.totalBadges')}</p>
          ...
          <div className="rounded-2xl bg-secondary-container p-3 text-on-secondary-container">
            <p className="text-[11px] font-medium uppercase tracking-wider opacity-75">{t('achievements.nextFocus')}</p>
        ...
        <section className="mobile-panel mt-4 p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-[11px] font-medium uppercase tracking-wider text-secondary">{t('achievements.currentLevel')}</p>
              <h2 className="truncate text-base font-medium">{t(rewardProgress.currentLevel.titleKey)}</h2>
            </div>
          </div>
        ...
        {ACHIEVEMENT_CATEGORIES.map(category => {
          ...
          return (
            <section key={category} className="space-y-2">
              <h2 className="px-1 text-sm font-medium text-on-surface">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-start justify-between gap-2">
                            <h3 className="line-clamp-1 text-sm font-medium text-on-surface">{t(achievement.titleKey)}</h3>
                            <span className="shrink-0 text-xs font-medium tabular-nums text-on-surface-variant">{progress}%</span>
                          </div>
