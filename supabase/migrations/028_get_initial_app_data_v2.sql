-- supabase/migrations/028_get_initial_app_data_v2.sql
-- Fix: get_initial_app_data_v2 RPC không tồn tại trên Supabase.
-- Code gọi RPC này để load profile, nhưng RPC bị thiếu → profile null.
--
-- Fix: tạo RPC với đầy đủ profile fields (display_name, avatar_url, v.v.)
-- Tham chiếu: SettingsPage → AuthContext → fetchInitialAppData → get_initial_app_data_v2
