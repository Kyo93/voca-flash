-- 042_user_character_evolution.sql
-- Sequential character evolution powered by spendable EXP.

ALTER TABLE user_character_unlocks
  ADD COLUMN IF NOT EXISTS current_stage INTEGER NOT NULL DEFAULT 1 CHECK (current_stage >= 1),
  ADD COLUMN IF NOT EXISTS evolution_spent_xp INTEGER NOT NULL DEFAULT 0 CHECK (evolution_spent_xp >= 0),
