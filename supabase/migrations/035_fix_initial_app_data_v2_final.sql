-- Migration 035: Final fix for get_initial_app_data_v2
-- Combines:
-- 1. Real retention_rate calculation from review logs (Migration 034 logic)
-- 2. Timezone-aware forecast (Live DB logic)
-- 3. Robust defaults for new users (returns 0 instead of 0.9 to trigger "No Data" UI)
